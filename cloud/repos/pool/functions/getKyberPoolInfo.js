const { kyberswapABI } = require("../abi/abis");
...
const getKyberPoolInfo = async (address, balance) => {
    try {
        // Use kyberswapABI to create the contract
        const contract = new web3.eth.Contract(kyberswapABI, address);
...
module.exports = { getKyberPoolInfo };